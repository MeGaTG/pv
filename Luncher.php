...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://reza-pvresaan.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://reza-pvresaan.rhcloud.com/'.$chat_id.'/pvresan.php');
...
✅برای ثبت ربات دیگر به ادمین مراجعه کرده و و مبلغ  2000  تومان پرداخت کنید تا صاحب ربات پیام رسان های بیشتر شوید.
✨ادمین :
@Hextor_Admin
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://reza-pvresaan.rhcloud.com/'.$id.'/pvresan.php');
...
define('WEBHOOK_URL', 'https://reza-pvresaan.rhcloud.com/Luncher.php/');
